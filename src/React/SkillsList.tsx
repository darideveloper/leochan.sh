...
const SkillsList = () => {
  ...
  const skills = {
    "Développement Web": [
      ...
      "Pages de destination et sites vitrines",
      "Sites de portfolio",
    ],
    "Développement Mobile": [
      "Applications web adaptées au mobile",
      "Applications mobiles React Native",
    ],
    "Design UI/UX & Prototypage": [
      "Design UI avec Figma & Canva",
      "Recherche UX & améliorations",
      "Prototypage pour sites web & applications mobiles",
    ],
  };
        ...
        {Object.entries(skills).map(([category, items]) => (
          <li key={category} className="w-full">
            <div
              ...
              className="md:w-[400px] w-full bg-[var(--background)] rounded-2xl text-left hover:bg-white/5 transition-all border border-[var(--white-icon-tr)] cursor-pointer overflow-hidden"
            >
