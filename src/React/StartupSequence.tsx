      ...
      <div className="relative z-10 flex-1 flex flex-col p-6 md:p-12 overflow-hidden">
        ...
        {phase === "welcome" && (
          <div className="flex-1 flex flex-col items-center justify-center animate-in zoom-in fade-in duration-1000 ease-out">
            <h2 className="text-2xl md:text-7xl font-bold tracking-[0.1em] text-white drop-shadow-[0_0_20px_var(--primary)]">
              NEKOCORP_OS
            </h2>
        ...
        <button
          ...
          className="absolute bottom-8 left-1/2 -translate-x-1/2 text-[var(--muted)] hover:text-white transition-colors text-xs md:text-sm px-4 py-2 rounded cyber-glass whitespace-nowrap"
        >
          SKIP (ESC)
        </button>
      </div>
