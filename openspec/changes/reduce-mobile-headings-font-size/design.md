...
4. **src/components/projects.astro**: `h2` from `text-lg` to `text-sm` (or ~20% reduction) on mobile.
5. **src/components/contact.astro**: `h2` from `text-lg` to `text-sm` (or ~20% reduction) on mobile.
